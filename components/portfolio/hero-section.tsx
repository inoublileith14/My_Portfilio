      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-4 tracking-tight">
            <span className="text-foreground">Leith </span>
          ...
          <h2 className="text-xl md:text-2xl lg:text-3xl text-muted-foreground mb-6 font-mono">
            Full-Stack Engineer <span className="text-neon-cyan">|</span> React, Next.js, NestJS, Flutter
          </h2>

          {/* Description */}
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
            Software developer experienced in building scalable web and mobile solutions 
            for <span className="text-neon-magenta">healthcare</span>, <span className="text-neon-cyan">mobility</span>, and <span className="text-neon-purple">IoT</span> industries.
          </p>
